const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-CfP2A2uN.js","assets/index-BolKFsR6.js","assets/index-CZPKmOs3.css","assets/useCanvasOperations-CZQ6BvKq.js","assets/NodeCreator-D9fmPdS2.css"])))=>i.map(i=>d[i]);
import { bw as useNodeTypesStore, q as computed, c as useI18n, U as useWorkflowsStore, eI as MANUAL_TRIGGER_NODE_TYPE, gV as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bu as NodeConnectionTypes, bv as CHAT_TRIGGER_NODE_TYPE, gW as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, gX as OPEN_AI_NODE_TYPE, eA as SPLIT_IN_BATCHES_NODE_TYPE, gY as NO_OP_NODE_TYPE, eD as WEBHOOK_NODE_TYPE, eK as SCHEDULE_TRIGGER_NODE_TYPE, aR as useExternalHooks, a2 as useCanvasStore, e1 as AI_CATEGORY_LANGUAGE_MODELS, gZ as QA_CHAIN_NODE_TYPE, g_ as AGENT_NODE_TYPE, g$ as BASIC_CHAIN_NODE_TYPE, h0 as OPEN_AI_ASSISTANT_NODE_TYPE, aA as STICKY_NODE_TYPE, eG as TRIGGER_NODE_CREATOR_VIEW, c5 as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, L as useUIStore, r as ref, ft as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bK as KeyboardShortcutTooltip, bZ as defineAsyncComponent, bY as Suspense, F as Fragment, aq as __vitePreload, h1 as getMidCanvasPosition, h2 as DEFAULT_STICKY_WIDTH, h3 as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-BolKFsR6.js";
import { a as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-CZQ6BvKq.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-CfP2A2uN.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
    const emit = __emit;
