const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-VvZhKQwb.js","assets/index-BolKFsR6.js","assets/index-CZPKmOs3.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, au as useNDVStore, r as ref, ik as useElementSize, q as computed, hy as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, bZ as defineAsyncComponent, bY as Suspense, ie as TextWithHighlights, n as normalizeClass, ig as MappingPill, hq as Draggable, aq as __vitePreload, v as shorten, ij as getMappedExpression, il as isString, im as nonExistingJsonPath, aR as useExternalHooks, ai as useTelemetry, _ as _export_sfc } from "./index-BolKFsR6.js";
import { V as VueJsonPretty } from "./NodeDetailsView-v5wasLcI.js";
import "./import-curl-D3vA_y5V.js";
import "./FileSaver.min-_h3vjrbO.js";
import "./RunDataAi-CFnvZB7Q.js";
import "./useCanvasOperations-CZQ6BvKq.js";
import "./useExecutionHelpers-C7k4a6Dr.js";
import "./dateFormatter-BBHn7yLK.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-VvZhKQwb.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
