// ============================================================================
// N8N Neo4j Node: Delete Customer
// ============================================================================
import type {
	IExecuteFunctions,
	IDataObject,
...
export class Neo4jDeleteCustomer implements INodeType {

	// --- Node Description for n8n UI ---
	description: INodeTypeDescription = {
		displayName: 'Neo4j Delete Customer', // From TaskInstructions.md
		name: 'neo4jDeleteCustomer', // From TaskInstructions.md
		...
		try {
			...
			for (let i = 0; i < items.length; i++) {
				try {
					...
					const query = 'MATCH (c:Customer {customer_id: $customerId}) DETACH DELETE c';
					...
					returnData.push({ json: { success: true, deletedCustomerId: customerId }, pairedItem: { item: i } });
