// ============================================================================
// N8N Neo4j Node: Find Services by Business
// ============================================================================
import type {
	IExecuteFunctions,
	IDataObject,
...
export class Neo4jFindServicesByBusiness implements INodeType {
		...
		try {
			...
			for (let i = 0; i < items.length; i++) {
				try {
					...
					const query = 'MATCH (b:Business {business_id: $businessId})-[:OFFERS]->(s:Service) RETURN s {.*, service_id: s.service_id} AS service';
