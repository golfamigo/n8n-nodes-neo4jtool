// ============================================================================
// N8N Neo4j Node: List Resource Types
// ============================================================================
import type {
	IExecuteFunctions,
	IDataObject,
...
export class Neo4jListResourceTypes implements INodeType {

	// --- Node Description for n8n UI ---
	description: INodeTypeDescription = {
		displayName: 'Neo4j List Resource Types', // From TaskInstructions.md
		name: 'neo4jListResourceTypes', // From TaskInstructions.md
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		try {
			...
			// 4. Loop Through Input Items (Typically runs once for this node type)
			for (let i = 0; i < items.length; i++) {
				try {
					...
					// The result will be multiple items if there are multiple types,
					// runCypherQuery and prepareOutputData handle this structure.
